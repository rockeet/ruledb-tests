...
Original__UnionDFA: states=46 transitions=988 mem=4776 | per-state: trans=21.478 mem=103.826 | fragmem=84
Minimized_UnionDFA: states=25 transitions=689 mem=2676 | per-state: trans=27.560 mem=107.040 | fragmem=0
Pathziped_UnionDFA: states=22 transitions=686 mem=2392 | per-state: trans=31.182 mem=108.727 | fragmem=0
